...
python3 train.py --type intra --emb_type ELMo --emb_path '../../data/embedding/ELMo/1024' --gpu 0 --case ga --dump_dir intra/ELMo/ga
python3 train.py --type intra --emb_type ELMo --emb_path '../../data/embedding/ELMo/1024' --gpu 0 --case o --dump_dir intra/ELMo/ga
python3 train.py --type intra --emb_type ELMo --emb_path '../../data/embedding/ELMo/1024' --gpu 0 --case ni --dump_dir intra/ELMo/ga
