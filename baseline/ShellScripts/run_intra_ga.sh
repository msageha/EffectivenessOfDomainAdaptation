...
python3 test.py --gpu 0 --load_dir "intra/Word2Vec_Fix/All_PB/ga"
python3 test.py --gpu 0 --load_dir "intra/Word2Vec/All_PM/ga"
python3 test.py --gpu 0 --load_dir "intra/Word2Vec_Fix/All_PM/ga"
python3 test.py --gpu 0 --load_dir "intra/Word2Vec/All_PN/ga"
python3 test.py --gpu 0 --load_dir "intra/Word2Vec_Fix/All_PN/ga"