...
python3 train.py --type intra --emb_type ELMoForManyLangs --emb_path '../../data/embedding/ELMoForManyLangs/Japanese' --gpu 0 --case o --dump_dir 'intra/ELMo/ELMoForManyLangs/o' --emb_dim 1024 --epochs 30
python3 test.py --gpu 0 --load_dir 'intra/ELMo/ELMoForManyLangs/o'
