...
python3 train.py --type intra --emb_type ELMo --emb_path ../../data/embedding/ELMo/1024 --gpu 0 --case ni --dump_dir intra/ELMo/1024/ni --emb_dim 1024 --epochs 30
python3 test.py --gpu 0 --load_dir intra/ELMo/1024/ni
